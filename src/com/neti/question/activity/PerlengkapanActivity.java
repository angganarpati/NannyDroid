...
public class PerlengkapanActivity extends Activity {
	...
	List<QuestionPerlengkapan> quesList;
	int nilai_perlengkapan;
	int qid=0;
	QuestionPerlengkapan currentQ;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		session = new SessionManager (PerlengkapanActivity.this);
		
		DatabaseHandler db=new DatabaseHandler(this);
		quesList=db.getAllQuestionPerlengkapan();
		...
		butNext.setOnClickListener(new View.OnClickListener() {		
			...
			public void onClick(View v) {
				...
				{
					nilai_perlengkapan = nilai_perlengkapan + 2;
					Log.d("nilai_perlengkapan", "Your score"+nilai_perlengkapan);
				}
				if(qid<5){					
					currentQ=quesList.get(qid);
					setQuestionView();
			        ...
			        session.createScorePerlengkapan(nilai_perlengkapan);  
					Intent intent = new Intent(PerlengkapanActivity.this, PsikologiActivity.class);
