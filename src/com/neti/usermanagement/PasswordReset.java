...

                {
                    ...
                    protected void onPostExecute(Boolean th){
                        ...
                        if(th == true){
                            ...
                            nDialog.dismiss();
                            alert.showAlertDialog(PasswordReset.this, "Failed", "Error in Network Connection.", false);
                        }
                    }
                }
                        ...
                        try {
                            if (json.getString(KEY_SUCCESS) != null) {
                                ...
                                if(Integer.parseInt(res) == 1){
                                   pDialog.dismiss();
                                   alert.showAlertDialog(PasswordReset.this, "Success", "A recovery email is sent to you, see it for more details.", true);

                                }
                                else if (Integer.parseInt(red) == 2)
                                {    pDialog.dismiss();
                                alert.showAlertDialog(PasswordReset.this, "Failed", "Your email does not exist in our database.", false);
                                }
                                else {
                                    pDialog.dismiss();
                                    alert.showAlertDialog(PasswordReset.this, "Failed", "Error occured in changing Password.", false);
                                }
