...
public class ChangePassword extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        public void onClick(View arg0){
                ...
                Intent login = new Intent(getApplicationContext(), UserMainActivity.class);
                startActivity(login);
                finish();
            }
    ...
    private class NetCheck extends AsyncTask<String,String,Boolean>
    {
        ...
        protected void onPostExecute(Boolean th){
            ...
            if(th == true){
                ...
                nDialog.dismiss();
                alert.showAlertDialog(ChangePassword.this, "Failed", "Error in Metwork Connection", false);
            }
        }
    }
            ...
            try {
                if (json.getString(KEY_SUCCESS) != null) {
                    ...
                    if (Integer.parseInt(res) == 1) {
                         ...
                         **/
                        pDialog.dismiss();
                        alert.showAlertDialog(ChangePassword.this, "Success", "Your Password is successfully changed.", true);


                    } else if (Integer.parseInt(red) == 2) {
                        pDialog.dismiss();
                        alert.showAlertDialog(ChangePassword.this, "Failed", "Invalid old Password.", false);
                    } else {
                        pDialog.dismiss();
                        alert.showAlertDialog(ChangePassword.this, "Failed", "Error occured in changing Password.", false);
                    }
