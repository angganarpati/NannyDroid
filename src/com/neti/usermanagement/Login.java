        ...
        **/
        ...
        protected void onPostExecute(Boolean th){
            ...
            if(th == true){
                ...
                nDialog.dismiss();
                //error.setText("");
               alert.showAlertDialog(Login.this, "Failed", "Error in Network Connection", false);
            }
        }
    }
            ...
            try {
               if (json.getString(KEY_SUCCESS) != null) {
                    ...
                    if(Integer.parseInt(res) == 1){
                        ...
                        **/
                        Intent upanel = new Intent(getApplicationContext(), UserMainActivity.class);
                        ...
                        pDialog.dismiss();
                        //error.setText("");
                        alert.showAlertDialog(Login.this, "Failed", "Incorrect username/password", true);
                    }
                }
